...
export const metadata: Metadata = {
  title: "Completar rutina manualmente",
  description:
    "Completá el formulario guiado y generá una rutina validada sin depender de IA.",
};

type SearchParameters = Record<string, string | string[] | undefined>;

export default async function ManualRoutinePage({
  searchParams,
}: {
